                    ...
                    <div class="me-n7 pe-7" data-kt-scroll-max-height="auto">
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 fv-row form-group">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="{{__('name')}}" value="{{$product->name}}" name="name" id="name" required autofocus />
                                @error('name')
                                <script>
                            ...
                            <div class="col-md-6 fv-row form-group">
                                ...
                                <textarea type="text" class="form-control form-control-solid tinymce-editor" placeholder="{{$product->descriptionlist}}" value="{{old('descriptionlist')}}" name="descriptionlist" id="descriptionlist" >{!!$product->descriptionlist!!}</textarea>
