...
<head>
    ...
    <meta property="og:site_name" content="{{$settings->title}}">
    @else
    <meta property="og:title" content="SAMSOLVE" />
    <title>SAMSOLVE</title>
    <meta property="og:site_name" content="SAMSOLVE" />
    <meta name="author" content="SAMSOLVE">
    <meta property="og:title" content="SAMSOLVE">
    <meta property="og:site_name" content="SAMSOLVE">
    @endif
    {{-- title --}}
