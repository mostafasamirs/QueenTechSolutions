            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h4 class="d-flex align-items-center text-muted  fw-bolder fs-6 my-1">{{ __('Users') }}
                        ...
                        <!--end::Separator-->
                        <!--begin::Description-->
                        <h3 class="text-dark fs-5 fw-bold my-1 ms-1">{{ __('Update User') }}
                            ({{ $user->name }})
                        </h3>
                        <!--end::Description-->
                    </h4>
        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">{{ __('Update User') }}</span>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-12 fv-row form-group">
                                    ...
                                    <input type="text" class="form-control form-control-solid"
                                        placeholder="{{ __('Name') }}" value="{{ $user->name }}" name="name"
                                        id="name" required />
                                    @error('name')
                                        <script>
                                ...
                                <div class="col-md-6 fv-row form-group">
                                    ...
                                    <input type="text" class="form-control form-control-solid"
                                        placeholder="{{ __('Address') }}" value="{{ $user->address }}" name="address"
                                        id="address" />
                                    @error('address')
                                        <script>
