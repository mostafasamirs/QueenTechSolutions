    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h4 class="d-flex align-items-center text-muted  fw-bolder fs-6 my-1">{{__('Users')}}
                    <!--begin::Separator-->
                    <span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
                    <!--end::Separator-->
                    <!--begin::Description-->
                    <h3 class="text-dark fs-5 fw-bold my-1 ms-1">{{__('Create User')}}</h3>
                    <!--end::Description-->
                </h4>
                <!--end::Title-->
            </div>
                    ...
                    <div class="me-n7 pe-7" data-kt-scroll-max-height="auto">
                        <div class="row mb-4">
                            ...
                            <div class="col-md-12 fv-row form-group">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="{{__('Name')}}" value="{{old('name')}}" name="name" id="name" required autofocus />
                                @error('name')
                                <script>
                            ...
                            <div class="col-md-6 fv-row form-group">
                                ...
                                <input type="email" class="form-control form-control-solid" placeholder="{{__('Email')}}" value="{{old('email')}}" name="email" id="email" required />
                                @error('email')
                                <script>
                            ...
                            <div class="col-md-6 fv-row form-group">
                                ...
                                <input type="number" class="form-control form-control-solid" placeholder="{{__('Phone')}}" value="{{old('phone')}}" name="phone" id="phone" required />
                                @error('phone')
                                <script>
                            ...
                            <div class="col-md-6 fv-row form-group">
                                ...
                                <input type="password" class="form-control form-control-solid" placeholder="{{__('Password')}}" value="" name="password" id="password-field" required />
                            ...
                            <div class="col-md-6 fv-row form-group">
                                ...
                                <input type="password" class="form-control form-control-solid " placeholder="{{__('password confirmation')}}" value="" name="password_confirmation" id="password-fields" required />
                            ...
                            <div class="col-md-6 fv-row form-group">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="{{__('Address')}}" value="{{old('address')}}" name="address" id="address" />
                                @error('address')
                                <script>
