                                ...
                                <div class="d-flex flex-wrap flex-stack">
                                    ...
                                    <div class="d-flex flex-column flex-grow-1 pe-8">
                                        ...
                                        <div class="d-flex flex-wrap">
                                            <!--begin::Stat-->
                                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3  d-none" style="">
                                                ...
                                                <div class="me-n7 pe-7" data-kt-scroll-max-height="auto">
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-md-12 fv-row form-group">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid" placeholder="{{__('Name')}}" value="{{$user->name}}" name="name" id="name" required />
                                                            @error('name')
                                                            <script>
                                                        ...
                                                        <div class="col-md-6 fv-row form-group">
                                                            ...
                                                            <input type="email" class="form-control form-control-solid" placeholder="{{__('Email')}}" value="{{$user->email}}" name="email" id="email" required />
                                                            @error('email')
                                                            <script>
                                                        ...
                                                        <div class="col-md-6 fv-row form-group">
                                                            ...
                                                            <input type="number" class="form-control form-control-solid" placeholder="{{__('phone')}}" value="{{$user->phone}}" name="phone" id="phone" required />
                                                            @error('phone')
                                                            <script>
                                                        ...
                                                        <div class="col-md-6 fv-row form-group">
                                                            ...
                                                            <input type="password" class="form-control form-control-solid" placeholder="{{__('Password')}}" value="" name="password" id="password-field" />
                                                        ...
                                                        <div class="col-md-6 fv-row form-group">
                                                            ...
                                                            <input type="password" class="form-control form-control-solid" placeholder="{{__('password confirmation')}}" value="" name="password_confirmation" id="password-fields" />
                                                    ...
                                                    <div class="col-md-6 fv-row form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-solid" placeholder="{{__('Address')}}" value="{{$user->address}}" name="address" id="address" />
                                                        @error('address')
                                                        <script>
