                    ...
                    <div class="me-n7 pe-7" data-kt-scroll-max-height="auto">
                        <div class="row mb-4">
                            ...
                            <div class="col-md-12 fv-row form-group">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="{{__('Title')}}" value="{{$setting->title}}" name="title" id="title" required autofocus/>
                                @error('title')
                                <script>
                            ...
                            <div class="col-md-6 fv-row form-group">
                                ...
                                <input type="email" class="form-control form-control-solid" placeholder="{{__('Email')}}" value="{{$setting->email}}" name="email" id="email" />
                                @error('email')
                                <script>
                            ...
                            <div class="col-md-6 fv-row form-group">
                                ...
                                <input type="number" class="form-control form-control-solid" placeholder="{{__('phone')}}" value="{{$setting->phone}}" name="phone" id="phone" />
                                @error('phone')
                                <script>
                            ...
                            <div class="col-md-6 fv-row form-group">
                                ...
                                <input type="url" class="form-control form-control-solid" placeholder="{{__('link')}}" value="{{$setting->link}}" name="link" id="link" />
                                @error('link')
                                <script>
                            ...
                            <div class="col-md-6 fv-row form-group">
                                <!--begin::Input-->
                                <label for="facebook" class="required fs-5 fw-bold mb-2">{{__('facebook')}}</label>

                                <input type="url" class="form-control form-control-solid" placeholder="{{__('facebook')}}" value="{{$setting->facebook}}" name="facebook" id="facebook" />
                                @error('facebook')
                                <script>
                            ...
                            <div class="col-md-6 fv-row form-group">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="{{__('Location')}}" value="{{$setting->location}}" name="location" id="location" />
                                @error('location')
                                <script>
