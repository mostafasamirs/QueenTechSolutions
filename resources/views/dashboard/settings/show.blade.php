                                                ...
                                                <table class="table fs-6 fw-bold gs-0 gy-2 gx-2 m-0 cell-border table-bordered table-hover">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-gray-800">
                                                            <a href="{{$settings->link}}" target="_blank" class="btn btn-primary btn-hover-rise me-5" style="background-color: #427288!important">{{__('link')}}</a>
                                                        </td>
                                                    </tr>

                                                    <tr>
                                                        <td class="text-gray-400">{{__('Facebook')}}:</td>
                                                        <td class="text-gray-800">
                                                            <a href="{{$settings->facebook}}" target="_blank" class="btn btn-primary btn-hover-rise me-5" style="background-color: #1877f2!important" >{{__('Facebook')}}</a>
