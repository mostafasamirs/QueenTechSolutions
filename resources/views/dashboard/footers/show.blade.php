        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepends" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                ...
                <h4 class="d-flex align-items-center text-muted  fw-bolder fs-6 my-1">{{__('footers')}}
                    ...
                    <!--end::Separator-->
                    <!--begin::Description-->
                    <h3 class="text-dark fs-5 fw-bold my-1 ms-1">{{__('Show footer')}} (
    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">{{__('Show footer')}}</span>
                                                ...
                                                <table class="table fs-6 fw-bold gs-0 gy-2 gx-2 m-0">
                                                    ...
                                                    <!-- <tr>
                                                        ...
                                                        <td class="symbol symbol-150px   mb-7">
                                                            <img src="{{asset($footer->image)}}" class="imagestyle stylenew" alt="image" loading="lazy" />
                                                        </td>
                                                    </tr> -->
                                                    <!--end::Row-->
