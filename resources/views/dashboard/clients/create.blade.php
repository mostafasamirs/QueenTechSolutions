                        ...
                        <div class="row mb-4">
                         ...
                         <div class="col-md-6 fv-row form-group">
                            ...
                            <div class="col-md-6 fv-row form-group">
                                ...
                                <textarea type="text" class="form-control form-control-solid" placeholder="{{__('description')}}" value="{{old('description')}}" name="description" id="description" required ></textarea>
                                @error('description')
                                <script>
